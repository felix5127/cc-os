...
Claude 应该能识别并读取 CLAUDE.md 中的 CC-OS 配置。
...
> **CC-OS 哲学**: 架构即认知，文档即记忆。系统是否可靠，取决于它是否记得自己是谁。
